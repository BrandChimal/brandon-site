...
const GlobalStyles = () => (
  <style>{`
    ...
    /* Animaciones súper vistosas con curva elástica (Spring) */
    ...
    /* Inputs - Ahora con SOMBRA EXTERIOR vistosa */
    ...
    .input-neumorphism:hover, .input-neumorphism:focus-within {
      ...
      /* Sombra exterior vistosa (drop-shadow real) en lugar de inset */
    ...
    <section id="costo" ref={sectionRef} className="py-20 md:py-32 bg-[#1A1714] relative">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
        <div className="lg:col-span-5 relative">
          <motion.div style={{ y: typeof window !== 'undefined' && window.innerWidth > 1024 ? yParallax : 0 }} className="relative lg:sticky lg:top-32">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          {cards.map((card, i) => (
            <motion.div key={i} initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, ease: "easeOut" }} className="glass-panel neumorphism-dark rounded-2xl p-6 md:p-8">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 relative overflow-hidden py-20 md:py-32 px-6 md:px-12 lg:px-24">
          ...
          <div className="relative z-20">
            ...
            <div className="space-y-12 md:space-y-16">
              {steps.map((step, i) => (
                <motion.div key={i} initial={{ opacity: 0.2, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, amount: 0.4 }} transition={{ duration: 0.6, ease: "easeOut" }} className="flex flex-col justify-center neumorphism-dark p-6 rounded-2xl border border-transparent bg-[#1A1714]/40 md:bg-transparent">
                  ...
                  <p className="text-[14px] md:text-[16px] text-[#B8AFA6] leading-relaxed sm:ml-12 mb-4 max-w-md">{step.desc}</p>
                  <p className="font-azeret text-[10px] text-[#8C8378] sm:ml-12 max-w-sm uppercase leading-relaxed border-l border-[#6B2D3C] pl-4">{step.tools}</p>
                </motion.div>
              ))}
            </div>
        ...
        <div className="hidden md:block md:w-1/2 relative">
          <div className="sticky top-0 h-screen overflow-hidden">
            <img src="https://i.ibb.co/pv9dQ2dV/method-system.webp" alt="System Workflow" className="w-full h-full object-cover grayscale-[20%]" />
  ...
  return (
    <section id="resultados" className="relative py-20 md:py-32 bg-[#1A1714] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-6">
        <h2 className="font-outfit text-3xl md:text-[44px] font-medium text-[#FFF3C2] text-center mb-12 md:mb-16 drop-shadow-lg">Lo que pasa cuando la conexión funciona.</h2>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 auto-rows-auto">
          <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6 }} className="glass-panel neumorphism-dark p-6 md:p-8 rounded-[20px] md:col-span-7 flex flex-col justify-between">
            <div><h3 className="font-azeret text-[48px] md:text-[72px] font-medium text-[#FFF3C2] mb-2 leading-none">+30%</h3><p className="font-azeret text-[10px] md:text-[11px] uppercase tracking-[2px] md:tracking-[3px] text-[#8C8378] mb-4">CONVERSIÓN LEAD → CLIENTE</p><p className="text-[14px] md:text-[15px] text-[#B8AFA6] leading-relaxed max-w-md">Flujos automatizados en la industria de reclutamiento y desarrollo organizacional. Leads que llegaban fríos empezaron a llegar listos.</p></div>
            <div className="mt-8 pt-6 border-t border-[#FFF3C2]/10"><p className="text-[13px] md:text-[14px] italic text-[#E8DDB0] mb-4">"Enfocado en resultados y en mejorar la experiencia de los usuarios y clientes... impactando de manera positiva cada punto en el journey."</p><p className="font-outfit text-[12px] md:text-[13px] font-medium text-[#F5F1EB]">Cecilia Caballero</p><p className="font-azeret text-[9px] md:text-[10px] text-[#8C8378] mt-1 uppercase">Comunicación Corporativa y Marketing Digital B2B</p></div>
          </motion.div>
          <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, delay: 0.1 }} className="glass-panel neumorphism-dark p-6 md:p-8 rounded-[20px] md:col-span-5 flex flex-col justify-between">
            <div><h3 className="font-azeret text-[48px] md:text-[72px] font-medium text-[#FFF3C2] mb-2 leading-none">+25%</h3><p className="font-azeret text-[10px] md:text-[11px] uppercase tracking-[2px] md:tracking-[3px] text-[#8C8378] mb-4">CONVERSIONES REGIONALES</p><p className="text-[14px] md:text-[15px] text-[#B8AFA6] leading-relaxed">Estrategia inbound para LATAM y Europa. Comunicación adaptada a cada mercado — no traducida, reescrita.</p></div>
            <div className="mt-8 pt-6 border-t border-[#FFF3C2]/10"><p className="text-[13px] md:text-[14px] italic text-[#E8DDB0] mb-4">"Se percibió perfectamente el dominio de las herramientas más importantes para CRM y un vasto conocimiento de estrategias."</p><p className="font-outfit text-[12px] md:text-[13px] font-medium text-[#F5F1EB]">Heidy Esquinca</p><p className="font-azeret text-[9px] md:text-[10px] text-[#8C8378] mt-1 uppercase">Head of Ecommerce</p></div>
          </motion.div>
          <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, delay: 0.2 }} className="md:col-span-7 h-56 md:h-full md:min-h-[300px] rounded-[20px] overflow-hidden relative group neumorphism-dark border border-transparent">
            <img src="https://i.ibb.co/bgT2Yz1Q/evidence-metrics.webp" alt="Metrics Data" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[600ms] group-hover:scale-[1.05]" /><div className="absolute inset-0 border border-[#FFF3C2]/10 rounded-[20px] pointer-events-none" />
          </motion.div>
          <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, delay: 0.3 }} className="glass-panel neumorphism-dark p-6 md:p-8 rounded-[20px] md:col-span-5 flex flex-col justify-between">
          ...
          <motion.div initial={{ opacity: 0.3, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6 }} className="glass-panel neumorphism-dark p-6 rounded-[16px] md:col-span-4 border-[#FFF3C2]/5"><p className="text-[12px] md:text-[13px] italic text-[#E8DDB0] mb-4 leading-relaxed">"Brandon es un sólido profesional con alto sentido de compromiso; siempre plantea soluciones con visión estratégica."</p><p className="font-outfit text-[11px] md:text-[12px] font-medium text-[#F5F1EB]">Karla Azucena</p><p className="font-azeret text-[8px] md:text-[9px] text-[#8C8378] mt-1 uppercase">Diseñadora Digital</p></motion.div>
          <motion.div initial={{ opacity: 0.3, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.1 }} className="glass-panel neumorphism-dark p-6 rounded-[16px] md:col-span-4 border-[#FFF3C2]/5"><p className="text-[12px] md:text-[13px] italic text-[#E8DDB0] mb-4 leading-relaxed">"Profesional altamente capacitado en marketing cloud, experto en automatizaciones. Es un gusto trabajar día a día con él."</p><p className="font-outfit text-[11px] md:text-[12px] font-medium text-[#F5F1EB]">Estefanía Fajardo</p><p className="font-azeret text-[8px] md:text-[9px] text-[#8C8378] mt-1 uppercase">Segment Marketing</p></motion.div>
          <motion.div initial={{ opacity: 0.3, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6, delay: 0.2 }} className="glass-panel neumorphism-dark p-6 rounded-[16px] md:col-span-4 border-[#FFF3C2]/5"><p className="text-[12px] md:text-[13px] italic text-[#E8DDB0] mb-4 leading-relaxed">"Excelente compañero y profesional con un alto compromiso hacia su trabajo, siempre con la mejor actitud para apoyar al equipo."</p><p className="font-outfit text-[11px] md:text-[12px] font-medium text-[#F5F1EB]">Sergio Ángel</p><p className="font-azeret text-[8px] md:text-[9px] text-[#8C8378] mt-1 uppercase">Comunicador Visual</p></motion.div>
        </div>
...
const VisionSection = () => {
  ...
  const subSectionY = useTransform(scrollYProgress, [0, 1], [100, -100]);
  const subSectionOpacity = useTransform(scrollYProgress, [0.3, 0.6, 0.9], [0, 1, 0.5]);
  const subSectionScale = useTransform(scrollYProgress, [0.4, 0.6], [0.9, 1]);
  ...
  return (
    <section ref={ref} className="relative py-20 md:py-32 bg-[#F5F1EB] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-20 relative">
        <div className="lg:col-span-6 flex flex-col justify-between">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-10 md:mb-16">
            <div className="inline-flex items-center gap-2 border border-[#6B2D3C]/20 rounded-full px-4 py-1.5 mb-6 md:mb-8"><span className="font-azeret text-[9px] md:text-[10px] uppercase tracking-[2px] text-[#6B2D3C] font-medium">&gt; NUESTRA_VISIÓN</span></div>
            ...
            <div className="lg:hidden w-full h-[300px] sm:h-[400px] rounded-[24px] overflow-hidden shadow-lg mb-8 relative"><img src="https://i.ibb.co/fYBFmtK4/vision-portrait.webp" alt="Visión Estratégica" className="w-full h-full object-cover" /><div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black/60 to-transparent"><p className="font-azeret text-[9px] text-[#FFF3C2] uppercase tracking-widest mb-1">CONEXIÓN GENUINA</p><p className="font-outfit text-white text-base">Ver todo con la misma intención.</p></div></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-auto">
            <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6 }} className="bg-[#EBE6DE]/80 p-5 md:p-6 rounded-[16px] border border-[#EBE6DE] neumorphism-light"><p className="text-[12px] md:text-[13px] italic text-[#2D2926]/80 mb-4 md:mb-6 leading-relaxed">"Si algo podemos destacar de él, es su empatía, su disponibilidad y su lealtad."</p><p className="font-outfit text-[12px] md:text-[13px] font-bold text-[#2D2926]">Rafael Gómez Albarrán</p><p className="font-azeret text-[9px] md:text-[10px] uppercase text-[#6B2D3C] mt-1">CMCO</p></motion.div>
            <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, delay: 0.1 }} className="bg-[#EBE6DE]/80 p-5 md:p-6 rounded-[16px] border border-[#EBE6DE] neumorphism-light"><p className="text-[12px] md:text-[13px] italic text-[#2D2926]/80 mb-4 md:mb-6 leading-relaxed">"Su trabajo va más allá de crear una página web, sino de grandes ideas y estrategias."</p><p className="font-outfit text-[12px] md:text-[13px] font-bold text-[#2D2926]">Erick Toledo</p><p className="font-azeret text-[9px] md:text-[10px] uppercase text-[#6B2D3C] mt-1">Community Manager</p></motion.div>
            <motion.div initial={{ opacity: 0.3, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6, delay: 0.2 }} className="bg-[#EBE6DE]/80 p-5 md:p-6 rounded-[16px] border border-[#EBE6DE] sm:col-span-2 neumorphism-light"><p className="text-[12px] md:text-[13px] italic text-[#2D2926]/80 mb-4 md:mb-6 leading-relaxed">"Una persona con un aprendizaje continuo, propositivo, muy inteligente, siempre emprendiendo nuevas ideas."</p><p className="font-outfit text-[12px] md:text-[13px] font-bold text-[#2D2926]">Carlos Castro Paniagua</p><p className="font-azeret text-[9px] md:text-[10px] uppercase text-[#6B2D3C] mt-1">Desarrollo de líderes y equipos</p></motion.div>
          </div>
        </div>
        <div className="lg:col-span-6 relative hidden lg:block h-full">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="sticky top-32 h-[80vh] w-full rounded-[32px] overflow-hidden shadow-[0_24px_64px_rgba(45,41,38,0.15)] relative">
      ...
      <motion.div style={{ y: typeof window !== 'undefined' && window.innerWidth > 768 ? subSectionY : 0, opacity: subSectionOpacity, scale: subSectionScale }} className="mt-20 md:mt-40 mb-10 md:mb-20 text-center max-w-5xl mx-auto px-6 relative z-20 py-12 md:py-24">
...
const ServiciosSection = () => {
  ...
  const ServiceCard = ({ svc, mobile }) => (
    <div className={`${mobile ? 'snap-center shrink-0 w-[85vw] min-h-[340px] rounded-[20px] p-6 sm:p-8' : 'w-[420px] h-[380px] rounded-[24px] p-10'} glass-panel neumorphism-dark flex flex-col group`}>
      <span className={`font-azeret ${mobile ? 'text-[32px]' : 'text-[40px]'} text-[#FFF3C2]/10 mb-auto block group-hover:text-[#FFF3C2]/30 transition-all duration-[600ms]`}>{svc.id}</span>
      <h3 className={`font-outfit ${mobile ? 'text-xl' : 'text-[24px]'} font-medium text-[#F5F1EB] ${mobile ? 'mb-3' : 'mb-4'}`}>{svc.title}</h3>
      <p className={`${mobile ? 'text-[14px] mb-6' : 'text-[15px] mb-8'} text-[#B8AFA6] leading-relaxed`}>{svc.desc}</p>
      <a href="#contacto" className={`mt-auto font-dm ${mobile ? 'text-[13px]' : 'text-[14px]'} text-[#FFF3C2] flex items-center gap-2 group/link w-fit transition-all duration-[600ms]`}>Preguntar por este servicio <ArrowRight size={14} className="group-hover/link:translate-x-1 transition-transform duration-[600ms]" /></a>
    </div>
  );
  return (
    <section id="servicios" className="relative z-10 bg-[#2D2926]">
      <div ref={targetRef} className="hidden md:block h-[300vh]">
        <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
          ...
          <div className="pl-[max(1.5rem,calc((100vw-80rem)/2))] relative z-10">
            <motion.div style={{ x }} className="flex gap-6 w-max">{services.map((svc) => (<motion.div key={svc.id} initial={{ opacity: 0.3 }} whileInView={{ opacity: 1 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6 }}><ServiceCard svc={svc} /></motion.div>))}</motion.div>
          </div>
        </div>
      </div>
      <div className="md:hidden py-24 relative overflow-hidden">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 px-6 pb-12 pt-4 hide-scrollbar relative z-10">{services.map((svc) => (<ServiceCard key={svc.id} svc={svc} mobile />))}</div>
      </div>
    </section>
  );
};
  ...
  return (
    <section id="pulso" className="py-20 md:py-32 bg-[#F5F1EB] relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.15)] overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        <motion.div initial={{ opacity: 0.3, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.2 }} transition={{ duration: 0.6 }} className="bg-white border border-[#EBE6DE] rounded-[24px] p-5 sm:p-6 md:p-10 neumorphism-light">
          <div className="space-y-2 mb-8 md:mb-10">
            {questions.map((item) => (
              <div key={item.id} className="border-b border-[#EBE6DE] last:border-0">
                ...
                <AnimatePresence>
                  {openQ === item.id && (<motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden"><textarea className="w-full bg-[#F5F1EB] border border-[#EBE6DE] rounded-xl p-4 text-[#2D2926] text-[14px] focus:outline-none focus:border-[#6B2D3C]/30 focus:ring-1 focus:ring-[#6B2D3C]/30 mb-4 transition-all duration-[600ms] input-neumorphism" rows="3" placeholder="Escribe tu respuesta aquí..."></textarea></motion.div>)}
                </AnimatePresence>
              </div>
            ))}
          </div>
          <div className="flex flex-col sm:flex-row gap-4 items-center w-full">
            <input type="email" placeholder="¿Dónde te enviamos tu Pulso Express?" className="flex-1 w-full bg-white border border-[#EBE6DE] rounded-full px-5 md:px-6 py-4 text-[#2D2926] text-sm focus:outline-none focus:border-[#6B2D3C]/50 focus:ring-1 focus:ring-[#6B2D3C]/50 transition-all duration-[600ms] placeholder-[#8C8378] input-neumorphism" />
            <Button className="w-full sm:w-auto !px-8 shadow-none text-sm md:text-base">Hacer mi Pulso Express</Button>
          </div>
        </motion.div>
        <p className="text-center font-dm text-[13px] md:text-[14px] text-[#8C8378] mt-8">Los números cuentan una parte. La conversación cuenta el resto.</p>
      </div>
    </section>
  );
};
        ...
        <div className="lg:col-span-6">
            ...
            <div className="space-y-3 md:space-y-4">
              {faqs.map((faq, i) => (
                <div key={i} className="border-b border-[#B8AFA6]/10 pb-3 md:pb-4">
                  <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full text-left py-2 flex justify-between items-center text-[15px] md:text-[16px] font-medium text-[#F5F1EB] hover:text-[#FFF3C2] transition-colors duration-[600ms] group">
                  ...
                  <AnimatePresence>
                    {openFaq === i && (<motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden"><p className="text-[14px] md:text-[15px] text-[#B8AFA6] pt-2 pb-4 pl-4 border-l border-[#FFF3C2]/10 mt-2 leading-relaxed">{faq.a}</p></motion.div>)}
                  </AnimatePresence>
                </div>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 md:gap-4">
              {[{ icon: "https://i.ibb.co/83Z4gL7/icon-calendly.jpg", text: "Calendly (sesión de 20 min)" },{ icon: "https://i.ibb.co/rfzxGSTm/icon-whatsapp.jpg", text: "WhatsApp (mensaje directo)" },{ icon: "https://i.ibb.co/mVX2dcv3/icon-email.jpg", text: "Email (directo)" }].map((link, i) => (
                <a key={i} href="#" className="flex items-center gap-4 group p-2 hover:bg-[#1A1714]/40 rounded-xl transition-all duration-[600ms] border border-transparent hover:border-[#FFF3C2]/5 w-fit">
                  <img src={link.icon} alt="" className="w-8 h-8 rounded-[8px] border border-[#FFF3C2]/10 group-hover:border-[#FFF3C2]/30 transition-colors duration-[600ms]" />
        ...
        <div className="lg:col-span-6 relative mt-12 lg:mt-0">
          <div className="lg:sticky lg:top-32">
            ...
            <form className="space-y-4 md:space-y-5 w-full" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="relative group w-full"><label className="absolute -top-2 left-4 bg-[#2D2926] px-1 text-[9px] md:text-[10px] text-[#B8AFA6] z-10 font-azeret uppercase">¿Qué necesitas?</label><textarea placeholder="Cuéntame sobre tu proyecto..." rows="4" className="w-full bg-[#1A1714]/40 border border-[#B8AFA6]/20 rounded-xl px-5 py-4 text-[#F5F1EB] text-[14px] focus:outline-none focus:border-[#FFF3C2]/50 placeholder-[#8C8378] resize-none input-neumorphism"></textarea><MessageSquare size={18} className="absolute right-4 top-5 text-[#8C8378] group-focus-within:text-[#FFF3C2] transition-colors duration-[600ms]" /></div>
              <div className="pt-4 md:pt-6 flex flex-col items-center gap-4 w-full"><Button className="w-full rounded-xl !py-4 font-medium text-[16px] tracking-wide" variant="primary">Conversemos</Button></div>
            </form>
          </div>
        </div>
      </div>
